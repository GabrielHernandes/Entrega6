...
public class SubjectListAdapter extends RecyclerView.Adapter<SubjectViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SubjectViewHolder holder, int position) {
        ...
        holder.editIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SubjectUpdateDialogFragment dialogFragment = SubjectUpdateDialogFragment.newInstance(subject, "Atualizar Disciplina", new SubjectCrudListener() {
                    @Override
    ...
    private void showConfirmationDialog(final int subjectId) {
        ...
        alertDialogBuilder.setMessage("Tem certeza de que deseja excluir esta disciplina?");
